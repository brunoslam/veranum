...
/**
 * Created by kaos on 08-12-15.
 */
public class gesSerExtraReservaController implements Initializable {
    ...
    public void llenarTabla() {
        ...
        int idCliente=gesRegistroServExtraController.clienteactual.getIdCliente();
    ...
    public void seleccionReserva(ActionEvent event) throws IOException {
...

        {
            ...
            gesRegistroServExtraController  gesCierreEstadia = loader.getController(); //accedo a controlador de pantalla origen
            gesCierreEstadia.setReserva(reserva);
            gesCierreEstadia.setClienteSelec(gesCierreEstadia.clienteactual);//paso objeto cliente

           gesCierreEstadia.estadoVentana(false,true,true,true);
    ...
    public void btnCancela(ActionEvent event) throws Exception {
        ...
        gesRegistroServExtraController regserviciosExtra = loader.getController(); //accedo a controlador de pantalla origen


        regserviciosExtra.setClienteSelec(regserviciosExtra.clienteactual);
        regserviciosExtra.estadoVentana(false,true,false,false);
        stage.show();
        lista.clear();
        tblReserva.setItems(lista);
