...
/**
 * Created by kaos on 21-11-15.
 */
public class gescCierreEstadiaListaClienteController implements Initializable {
    ...
    public void seleccionUsuario(ActionEvent event) throws IOException {
...

        {
            ...
            gesCierreEstadia.setClienteSelec(cliente); //paso objeto cliente
            gesCierreEstadia.estadoVentana(false, true, false, false);
 //           registrarEstadiaController.estadoEntrada(true,true,false,false);
    ...
    public void btnCancela(ActionEvent event) throws Exception {
        ...
        stage.setScene(scene);
        gesCierreEstadiaController  gesCierreEstadia = loader.getController();
        gesCierreEstadia.estadoVentana(true,false,false,false);
