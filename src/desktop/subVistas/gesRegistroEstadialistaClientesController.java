 ...
 */
public class gesRegistroEstadialistaClientesController implements Initializable {
    ...
    public void seleccionUsuario(ActionEvent event) throws IOException {
...

        {
            ...
            gesRegistrarEstadiaController registrarEstadiaController = loader.getController(); //accedo a controlador de pantalla origen
            registrarEstadiaController.setClienteSelec(cliente); //paso objeto cliente
            registrarEstadiaController.setFechiniAct(fechiniAct);
            registrarEstadiaController.setfechafinAct(fechafinAct);
            registrarEstadiaController.estadoEntrada(true,true,false,false);
